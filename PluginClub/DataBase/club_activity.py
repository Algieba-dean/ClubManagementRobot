        ...
        try:
            ...
            if command == ".发起活动":
                result_content += "\n<.发起活动>\n" \
                                  ...
                                  "\n\n参数介绍: [" \
                                  "\n\t活动名称: [XXX俱乐部_X月XX活动A] (必须参数,名称可任意,但是需要保证活动名称唯一)" \
                                  "\n\t活动开始时间: [2023-08-01] (必须参数, 日期格式按照范例即可,从当日0点1分1秒开始生效)" \
                                  "\n\t活动结束时间: [2023-08-30] (必须参数, 日期格式按照范例即可,截止当日23点59分59秒失效)" \
                                  "\n\t活动地点: [线上] (可选参数,可为任意内容) " \
                                  "\n\t活动人数限制: [30] (可选参数,非负整数类型,若活动设置积分,则必须配置该项," \
                                  "不设置积分时也可设置该参数)" \
                                  "\n\t活动积分预算: [300] (可选参数,非负整数类型,若活动设置其他积分配置,则必须配置该项)" \
                                  "\n\t单次参与/打卡积分奖励: [1] (可选参数, 非负整数类型, 若活动设置其他积分配置,则必须配置该项)" \
                                  "\n\t最大积分打卡次数: [10] (可选参数,若活动设置其他积分配置,则必须配置该项)" \
            ...
            if command == ".更新活动":
                result_content += "\n<.更新活动>\n" \
                                  ...
                                  "\n\n参数介绍: [" \
                                  "\n\t活动名称: [XXX俱乐部_X月XX活动A] (必须参数,待修改的活动名称)" \
            ...
            if command == "活动状态":
                result_content += "\n<.活动状态>\n" \
                                  ...
                                  "\n\n参数介绍: [" \
                                  "\n\t活动名称: [XXX俱乐部_X月XX活动A] (必须参数,待查询的活动名称)" \
                                  "\n\n]" \
                                  "\n完整使用示例如下" \
                                  "\n\n.活动状态" \
                                  "\n活动名称: [XXX俱乐部_X月XX活动A]"
            ...
            if command == "打卡":
                result_content += "\n<.打卡>\n" \
                                  ...
                                  "\n]" \
                                  "\n\n参数介绍: [" \
                                  "\n\t活动名称: [XXX俱乐部_X月XX活动A] (必须参数,待参与的活动名称)" \
            ...
            if command == ".操作积分":
                result_content += "\n<.操作积分>\n" \
                                  ...
                                  "\n]" \
                                  "\n\n参数介绍: [" \
                                  "\n\t俱乐部群名: [XXX俱乐部] (必须参数,待操作积分账户所在的俱乐部群名)" \
                                  "\n\t姓名: [aaa.bbb ccc.bbb ddd.bbb] (必须参数,待查询的用户,即邮箱前缀,@前的部分 " \
                                  "可以为多人 以空格隔开)" \
                                  "\n\t积分: [+/-/=10] (必须参数,待操作的积分数额和操作类型," \
            ...
            if command == ".消费积分":
                result_content += "\n<.消费积分>\n" \
                                  ...
                                  "\n\n参数介绍: [" \
                                  "\n\t俱乐部群名: [XXX俱乐部] (必须参数,待操作积分账户所在的俱乐部群名)" \
                                  "\n\t姓名: [aaa.bbb] (必须参数,待消费积分的用户,即邮箱前缀,@前的部分 " \
                                  "\n\t积分: [10] (必须参数, 待消费的积分数额)" \
            ...
            if command == ".捐献积分":
                result_content += "\n<.捐献积分>\n" \
                                  ...
                                  "\n\n参数介绍: [" \
                                  "\n\t俱乐部群名: [XXX俱乐部] (必须参数,待操作积分账户所在的俱乐部群名)" \
                                  "\n\t姓名: [aaa.bbb] (必须参数,待捐献积分的用户,即邮箱前缀,@前的部分 " \
                                  "\n\t积分: [10] (必须参数, 待捐献的积分数额)" \
                                  "\n\t备注: [捐献积分] (可选参数,备注内容)" \
                                  "\n\n]" \
                                  "\n完整使用示例如下" \
            ...
            if command == ".查询积分流水":
                result_content += "\n<.查询积分流水>\n" \
                                  ...
                                  "\n]" \
                                  "\n\n参数介绍: [" \
                                  "\n\t俱乐部群名: [XXX俱乐部] (必须参数,待查询积分账户所在的俱乐部群名)" \
                                  "\n\t姓名: [aaa.bbb] (必须参数,待查询积分的用户,即邮箱前缀,@前的部分 " \
                                  "\n\n]" \
                                  "\n完整使用示例如下" \
                                  "\n\n.查询积分流水" \
                                  "\n俱乐部群名: [XXX俱乐部]" \
