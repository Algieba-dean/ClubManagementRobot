...
class CommandHelper:
    ...
    def get_help_overview_details() -> str:
        output_message = "\n可用命令如下:\n" \
                         ".发起活动       -- 用于[管理员]发起活动 [群内使用]\n" \
                         ".更新活动       -- 用于[管理员]更改活动信息 [群内使用]\n" \
                         ".活动状态       -- 用于[管理员]查看活动参与情况 [群内使用 私聊使用]\n" \
                         ".打卡          -- 用于[所有人]参与活动 [群内使用]\n" \
                         ".操作积分       -- 用于[管理员]操作积分 [群内使用]\n" \
                         ".消费积分       -- 用于[所有人]消费积累的积分 [群内使用]\n" \
                         ".捐献积分       -- 用于[所有人]捐赠积分到COMMON用户 [群内使用]\n" \
                         ".查询积分余额    -- 用于[所有人]查询指定用户的积分余额 [群内使用]\n" \
                         ".查询积分流水    -- 用于[所有人]查询指定用户的积分流水 [私聊使用]\n" \
                         ".查询积分总榜    -- 用于[所有人]查询累计获得积分的积分榜 [群内使用 私聊使用]\n" \
                         ".查询余额总榜    -- 用于[所有人]查询积分余额的积分榜 [群内使用 私聊使用]\n"
